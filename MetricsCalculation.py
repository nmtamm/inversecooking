...
def get_pred_ingr_indices_from_vocab(ingrs, ingr_vocab_path):
    ...
    with open(ingr_vocab_path, "r", encoding="utf-8") as f:
        ingr_vocab = json.load(f)
    return [ingr_vocab.index(ingr) for ingr in ingrs if ingr in ingr_vocab]
...
def evaluate_ingredient_pairs(data_folder, full_ingr_path, brief_ingr_path, vocab_size):
    ...
    for gt_file in gt_files:
        ...
        for idx, recipe in enumerate(recipes):
            ...
            pred_indices = get_pred_ingr_indices_from_vocab(pred_ingrs, brief_ingr_path)
    ...
    return results, predicted_instr_list, ground_truth_instr_list
...
dir = "path-to-your-zipfiles-for-metrics-calculation"
